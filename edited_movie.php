...
<body>
    ...
    <?php
        ...
        if (!$link) {
            ...
            $queryUpdate = "UPDATE MOVIE SET title = '" . $title . "' , genre = '" . $genre . "' , description = '" . $describe . "' WHERE movieID = '" . $movieID . "' ";
            ...
            if (!$resultUpdate) {
                ...
                header("Location:successUpdate.html");
            }
        }
        ?>
