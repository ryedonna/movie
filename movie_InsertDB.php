...
<body>
    ...
    <?php
            ...
            if (!$link) {
                ...
                $target = "video/" . basename($videoName);

                $tarikhDaftar = date("Y-m-d");

                $queryInsert = "INSERT INTO MOVIE (movieID, videoName, title, genre, description, dateRegistered, status, userID) 
                values (NULL, '" . $videoName . "', '" . $title . "', '" . $genre . "', '" . $describe . "', '" . $tarikhDaftar . "', '" . $status . "', '" . $_SESSION["UID"] . "' )";
