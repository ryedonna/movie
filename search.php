    ...
    <?php
            ...
            if (!$link) {
                ...
                $querySearch = "SELECT * FROM MOVIE 
                            WHERE title LIKE '%" . $searchq . "%' OR genre LIKE '%" . $searchq . "%' OR description LIKE '%" . $searchq . "%' OR status LIKE '%" . $searchq . "%' or userID LIKE '%" . $searchq . "%' ";
        ...
        <center>
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Approve any new movie uploaded!</p>
